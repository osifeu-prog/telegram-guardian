...
class User(Base):
    ...
    withdrawals = relationship("app.database.models.Withdrawal", back_populates="user")
...
class Withdrawal(Base):
    ...
    user = relationship("app.database.models.User", back_populates="withdrawals")
...
class Invoice(Base):
    ...
    user = relationship("app.database.models.User", back_populates="invoices")
...
class Referral(Base):
    ...
    referrer = relationship("app.database.models.User", foreign_keys=[referrer_id], backref="referrals_made")
    referred = relationship("app.database.models.User", foreign_keys=[referred_id], backref="referred_by_user")
...
class P2POrder(Base):
    ...
    user = relationship("app.database.models.User", back_populates="p2p_orders")
...
class SellOrder(Base):
    ...
    user = relationship("app.database.models.User", back_populates="sell_orders")
...
class BuyOrder(Base):
    ...
    user = relationship("app.database.models.User", back_populates="buy_orders")
...
class Trade(Base):
    ...
    seller = relationship("app.database.models.User", foreign_keys=[seller_id], backref="trades_sold")
    buyer = relationship("app.database.models.User", foreign_keys=[buyer_id], backref="trades_bought")
